...
var _TestApp = __webpack_require__(28);
...
var App = exports.App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return React.createElement(_TestApp2.default, null);
        }
    }]);
...
var _TestItem = __webpack_require__(29);

var _TestItem2 = _interopRequireDefault(_TestItem);

var _StartTest = __webpack_require__(32);

var _StartTest2 = _interopRequireDefault(_StartTest);

var _FinishTest = __webpack_require__(33);

var _FinishTest2 = _interopRequireDefault(_FinishTest);
...
var TestApp = function (_React$Component) {
    ...
    function TestApp(props) {
        ...
        _this.state = {
            ...
            'currentTestNo': 0,
            'currentTest': { 'order': 1, 'title': 'first', 'options': [["1", "option 1", "D"], ["2", "option 2", "D"]] },
            'testResult': []
        };
        return _this;
    }
    ...
    _createClass(TestApp, [{
        ...
        value: function updateStateData() {
            var newTest = this.state.data.items[this.state.currentTestNo];
        ...
        key: 'renderAppHeader',
        value: function renderAppHeader() {
        ...
        key: 'renderStartTest',
        value: function renderStartTest() {
            var _this2 = this;
            ...
            return React.createElement(
                ...
                React.createElement(_StartTest2.default, { onClick: function onClick() {
                        return _this2.handleClickStartTest();
                    } })
            );
        }
    }, {
        key: 'handleClickStartTest',
        value: function handleClickStartTest() {
            this.setState({ currentState: TestAppStateEnum.RUNNING });
        }
    }, {
        key: 'renderFinishTest',
        value: function renderFinishTest() {
            var testResultCount = {};
            this.state.testResult.forEach(function (item) {
                return testResultCount[item] = (testResultCount[item] || 0) + 1;
            });
            var testResultMessage = JSON.stringify(testResultCount);
            return React.createElement(
                'div',
                null,
                this.renderAppHeader(),
                React.createElement(_FinishTest2.default, testResultCount)
            );
        }
    }, {
        key: 'renderTestItem',
        value: function renderTestItem() {
            var _this3 = this;
            ...
            return React.createElement(
                ...
                null,
                this.renderAppHeader(),
                React.createElement(_TestItem2.default, _extends({
                    key: this.state.currentTest.order
                }, this.state.currentTest, {
                    onClick: function onClick(order, value) {
                        return _this3.handleClick(order, value);
                    }
                }))
            );
        }
        ...
        key: 'handleClick',
        value: function handleClick(order, value) {
        ...
        value: function renderOption(i) {
            ...
            return React.createElement(
                ...
                this.props.options.map(function (item) {
                    return React.createElement(_Option2.default, { value: item[1], onClick: function onClick() {
...
var StartTest = function (_React$Component) {
    _inherits(StartTest, _React$Component);

    function StartTest() {
        _classCallCheck(this, StartTest);

        return _possibleConstructorReturn(this, (StartTest.__proto__ || Object.getPrototypeOf(StartTest)).apply(this, arguments));
    }
    ...
    _createClass(StartTest, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                "button",
                { className: "startTest", onClick: function onClick() {
                        return _this2.props.onClick();
                    } },
                "Start Test"
            );
...
var FinishTest = function (_React$Component) {
    _inherits(FinishTest, _React$Component);

    function FinishTest() {
        _classCallCheck(this, FinishTest);

        return _possibleConstructorReturn(this, (FinishTest.__proto__ || Object.getPrototypeOf(FinishTest)).apply(this, arguments));
    }

    _createClass(FinishTest, [{
        key: "render",
        value: function render() {
            return React.createElement(
                "button",
                { className: "finishTest" },
                "Finished Test, Thank you!"
            );
        }
    }]);
